                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <h2 class="section-title mt-3" style="color: #000699;"><strong>Des formulaires sur
                                            mesure pour noter vos clients en un instant.</strong></h2>
                                    <p class="mt-3" style="color: #000699;">Lorem ipsum dolor sit amet, consectetur
                                        adipiscing elit. Donec posuere auctor dui sit amet egestas.
                                        Pellentesque massa augue, sodales sed iaculis vel, malesuada vel tellus.
                                    </p>
                                    ...
                                    <div class="mt-5 button-container d-flex align-items-center ">
                                        ...
                                        <a class="bouton2 inscription-button ml-2 rounded-pill " href="#contact"><svg
                                                class="mr-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <div class="col-md-6 wh-100">
                                    ...
                                    <img class="" src="images/content1.png" alt="" style="max-width: 100%;">
      ...
      <section class="  pt-5 mr-5 m-auto">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-6 mb-100">
              <div class="seo-image">
                <img class="img-fluid" src="images/p34.png" alt="form-img">
              </div>
            </div>
          </div>
        </div>
